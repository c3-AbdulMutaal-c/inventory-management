            ...
            <div class="order-health-container">
              ...
              <div class="order-health-chart">
                <svg viewBox="0 0 200 200" class="donut-svg-compact">
                  ...
                  <circle cx="100" cy="100" r="65" fill="none" style="stroke: var(--color-primary)" stroke-width="25"
...
export default {
  ...
  setup() {
    ...
    const categoryData = computed(() => {
      ...
      const singleColor = 'var(--color-text-secondary)' // Neutral secondary-text color
